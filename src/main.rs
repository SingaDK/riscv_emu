...
// Default size of DRAM(128MiB).
pub const DRAM_SIZE: u64 = 1024 * 1024 * 128;

// The CPU contain registers, a program coutner, and DRAM.
struct Cpu {
    // 32 64-bit integer registers.
    regs: [u64; 32],
    // Program counter to hold the the dram address of the next 
...
impl Cpu {
    ...
    // Fetching instruction from DRAM
    fn fetch(&self) -> u32 {
    ...
    fn execute(&mut self, inst: u32) {
        ...
        // Emulate that register x0 is hardwired to 0.
        self.regs[0] = 0;
